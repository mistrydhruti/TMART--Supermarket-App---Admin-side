...
public class AddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductImageRef= FirebaseStorage.getInstance().getReference().child("Products").child(CategoryName);
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                //Toast.makeText(AddProductActivity.this, "Product Image Uploaded succesfuly", Toast.LENGTH_SHORT).show();
                Task<Uri> uriTask=uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                     if(task.isSuccessful())
                     {
                       ...
                       //  Toast.makeText(AddProductActivity.this, "got the product image uri successfully", Toast.LENGTH_SHORT).show();
        ...
        ProductRef.child(Pname).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                      if (task.isSuccessful()) {
                          //Intent i = new Intent(AddProductActivity.this, ShopByCategories.class);
    ...
    public void Go_to_home(View view) {
        Intent i = new Intent(AddProductActivity.this,Home.class);
        startActivity(i);
        finish(); }
}
