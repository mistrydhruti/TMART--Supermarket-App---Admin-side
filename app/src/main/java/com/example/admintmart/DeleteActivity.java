...
public class DeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cat=getIntent().getStringExtra("Categories");
        prodRef= FirebaseDatabase.getInstance().getReference().child("Products").child(Cat);
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.txt_delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        prodRef.child(model.getPname()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {

                              //  Toast.makeText(DeleteActivity.this, "Product Deleted Successfully", Toast.LENGTH_LONG).show();
                                AlertDialog.Builder builder1 = new AlertDialog.Builder(DeleteActivity.this);
                                builder1.setMessage("Product Deleted Successfully !");
    ...
    public void Go_to_home(View view) {
        Intent i = new Intent(DeleteActivity.this,Home.class);
        startActivity(i);
        finish(); }
