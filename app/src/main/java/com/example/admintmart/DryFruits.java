...
public class DryFruits extends AppCompatActivity {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(DryFruits.this,AdminMaintainActivity.class);
    ...
    public void Go_to_home(View view) {
        Intent i = new Intent(DryFruits.this,Home.class);
        startActivity(i);
        finish(); }

    @Override
    public void onBackPressed() {
        Intent i = new Intent(DryFruits.this,ShopByCategories.class);
